...
@section('content')
    ...
    <main class="bg-black font-inter">
        <section>
            <div class="flex justify-center h-profile  items-center flex-row p-5">
                ...
                <div class=" h-full  bg-white rounded-r-md rounded-t-md rounded-l-none p-5 w-2/5">
                    ...
                    <div class="mt-2.5">
                        <nav>
                            <ul class="flex items-center gap-2.5">
                                <li><span class="p-3px-12px bg-blue-500 text-white font-normal rounded-sm"><i class="fa-solid fa-location-dot pr-2 text-red-600"></i>Rio de Janeiro</span></li>
                                <li><span class="p-3px-12px bg-blue-500 text-white font-normal rounded-sm"><i class="fa-solid fa-venus pr-2"></i>Mulher</span></li>
                                <li><span class="p-3px-12px bg-blue-500 text-white font-normal rounded-sm"><i class="fa-solid fa-cake-candles pr-2"></i>25 Anos</span></li>
        ...
        <section >
            <div class="">
                <div class="p-3 grid grid-cols-7 gap-2.5">
                    ...
                    <div class="bg-pink p-3 rounded-md shadow-card gap-16 flex flex-col justify-between">
                        <h2 class=" font-semibold text-white text-2xl">Ohos</h2>
                        <h4 class=" font-normal text-white text-base">Castanhos</h4>
                    </div><div class="bg-pink p-3 rounded-md shadow-card gap-16 flex flex-col justify-between">
                        <h2 class=" font-semibold text-white text-2xl">Ohos</h2>
                        <h4 class=" font-normal text-white text-base">Castanhos</h4>
                    </div>
            ...
            <div class="">
                <div class="p-3 grid grid-cols-7 gap-2.5">
                    ...
                    <div class="bg-blue-500 p-3 rounded-md shadow-card gap-16 flex flex-col justify-between">
                        <h2 class=" font-semibold text-white text-2xl">Ohos</h2>
                        <h4 class=" font-normal text-white text-base">Castanhos</h4>
                    </div><div class="bg-blue-500 p-3 rounded-md shadow-card gap-16 flex flex-col justify-between">
                        <h2 class=" font-semibold text-white text-2xl">Ohos</h2>
                        <h4 class=" font-normal text-white text-base">Castanhos</h4>
                    </div>
                    <div class="bg-blue-500 p-3 rounded-md shadow-card gap-16 flex flex-col justify-between">
        ...
        <section>
            <div class="flex justify-center items-center flex-col pt-10 gap-8">
                <div class="">
                    <h2 class="text-3xl text-white font-extrabold underline"><i class="fa-solid fa-camera-retro pr-2"></i>Galeria</h2>
                </div>
                <div class="w-full max-w-5xl p-5 pb-10 mx-auto mb-10 gap-3 columns-3 space-y-3">
                    <img class="hover:border-2 border-2 border-transparent delay-150 transition-all hover:delay-200 hover:border-white rounded-md hover:cursor-pointer" src="https://images.pexels.com/photos/2737021/pexels-photo-2737021.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="">
                    <img class="hover:border-2 border-2 border-transparent delay-150 transition-all hover:delay-200 hover:border-white rounded-md hover:cursor-pointer" src="https://images.pexels.com/photos/3426975/pexels-photo-3426975.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="">
                    <img class="hover:border-2 border-2 border-transparent delay-150 transition-all hover:delay-200 hover:border-white rounded-md hover:cursor-pointer" src="https://images.pexels.com/photos/2811089/pexels-photo-2811089.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="">
                    <img class="hover:border-2 border-2 border-transparent delay-150 transition-all hover:delay-200 hover:border-white rounded-md hover:cursor-pointer" src="https://images.pexels.com/photos/16158164/pexels-photo-16158164/free-photo-of-bmw-istambul-abstrato-resumo.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="">
                </div>
            </div>
        </section>
        <section>
